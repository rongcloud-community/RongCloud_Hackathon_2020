...
<link type="text/css" rel="stylesheet" href="${ctx}/themes/css/base.css">
<link type="text/css" rel="stylesheet" href="${ctx}/themes/css/home.css">
<script type="text/javascript" src="${ctx}/themes/js/jquery.min.js"></script>
<script type="text/javascript" src="${ctx}/themes/js/slider.js"></script>
<script type="text/javascript" src="${ctx}/themes/js/tab.js"></script>
<script>
var ctx;
$(function(){
	init();
