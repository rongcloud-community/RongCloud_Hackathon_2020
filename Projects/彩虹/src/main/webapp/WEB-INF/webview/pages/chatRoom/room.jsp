...
<html>
  ...
  <body style="background-color: #F3F5F7;padding: 10px 0 0 0">
        ...
        message: function(event){
            ...
            if (message.senderUserId != "${param.userId}"){
                $(".pages").append('<div class="chat-sender">\n' +
                    '              <div><img src="${ctx}/themes/img/user/user-logo-005.png"></div>\n' +
                ...
                $(".pages").append('<div class="chat-receiver">\n' +
                    '              <div><img src="${ctx}/themes/img/user/user-logo-003.png"></div>\n' +
                    '              <div id="'+message.messageUId+'">'+ message.senderUserId +'</div>\n' +
                    '              <div>\n' +
