...
<%
	...
	String lvt=(String)session.getValue("lvt"); //lvt:last visit time
	String lvp=(String)session.getValue("lvp"); //lvt:last visit page
	...
	session.putValue("lvt",String.valueOf(time));
	session.putValue("lvp",String.valueOf(jspReferer));	 
 
 	////////////////////////////输出到javascript的tag中 所以不要再加tag
	out.print("\nvar time="+time+";\n");	 
	String script="<script language=JavaScript type=\'text/javascript\' src=\'http://webqq.3yan.com/scripts/script.js\'></script>";	 
