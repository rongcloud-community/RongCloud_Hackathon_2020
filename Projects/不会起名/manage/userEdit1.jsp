...
%>
<body>
<table width="803" height="34" border="1" cellpadding="0" cellspacing="0" bordercolor="#A5AdC4">
  <tr>
    <td width="803" bgcolor="#E4F2FF">修改用户信息</td>
  </tr>
</table>
<%
//***********************************
...
%>
<form id="UserForm2" name="UserForm2" method="post" action="userEditSave1.jsp?action=editUser&vid=<%=vid%>&sid=<%=sid%>">
  <table width="804" height="34" border="1" cellpadding="0" cellspacing="0" bordercolor="#A5AdC4">
    <tr>
      <td width="800"><table width="800" border="0" cellpadding="0" cellspacing="1" bgcolor="#B5CDFF" class="data">
        <tr>
          <td width="110" height="20" align="right" valign="middle" bgcolor="#FFFFFF">登录名：</td>
          <td width="676" height="20" align="left" valign="middle" bgcolor="#FFFFFF">&nbsp;
...
访问者呼入电话, 座机前加区号如 01051668337，手机前加0， 建议输入手机号码</td>
        ...
        <tr>
          <td height="30" colspan="2" align="left" valign="middle" bgcolor="#FFFFFF"><input type="submit" name="Submit" value="提交修改" />
            &nbsp;&nbsp;
