...
<script language="javascript" src="scripts/manage1.js"></script>
		...
		<script language="javascript">		 
			...
			{ 
				window.open("manage/clientManage.jsp?action=search&key="+key,"sw");
			}
...
<body  onLoad="SystemInitial();" oncontextmenu="return false;"  onclick="checkclick();">
		...
		<table width="100%" border="0" style="font-size:12px;background-image:url('img/talk/bg.gif');" height="93">
			...
			<tr>
				<td align="center" width="100%" style="padding-top:10px;">
					<P align="center">
					<input type="image" src="img/talk/ok.gif" onClick="voipform.style.display='none';manwin=window.open('manage/clientManage.jsp?action=leaveMsg&vid=<%=vid%>','ydmanage');manwin.focus();">&nbsp;&nbsp;&nbsp;
			...
			<td height="79">
				...
				<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" background="img/manage/t_4.gif">
					<tr>
						...
						<td width="560" id="maxtoolbar1" align='center'style="padding-left:10px;padding-right:10px;" >
							<div id="toolbar1"  style="background-color:#E3F7F9border:3px;width:550px;height:78px;">
							<!--
								<script language="JavaScript">
			...
			<td>
				...
				<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
										...
										<td>
											...
											<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
												<tr>
													...
													<td width="480" background="img/manage/m_22.gif" id="disp21" style="padding-top:2px;"><font style="color:#990000;font-size:12px;">当前用户：</font><span id="dialoger" style="font-size:12px;"></span></td>
										...
										<td height="160" valign="bottom">
											...
											<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
												...
												<tr>
													...
													<td id="talk21" width="530" background="img/manage/m_22.gif">
												...
												<tr>
													...
													<td id="talk51" width='530' background="img/manage/m_22.gif"><span id="talkstatus" style="color:gray;font-size:12px;"><span></td>
						...
						<td valign="top" id="mainright" align='center'>
							<!-- main-right -->
							 ...
							 <td>
								<table width="100%" height="100%" cellpadding="0" cellspacing="0" style="font-size:12px;color:#08789D;">
									...
									<!-- 快捷回复框开始 -->
									<tr>
										<td colspan='2' id="rightmiddle1" valign="top" width='100%' height="210">
											<div id="shortcutboard"  style="width:190;height:210;OVERFLOW:auto;color:#000000;font-size:12px;padding:5px;background-color:#CEEBFA;">										 
												<script language="JavaScript">
									...
									<tr>
										<td colspan='2' id="rightmiddle2" align="center" valign="top"  height='160'>
											<div id="ff" style="width:100%;height:160px;color:#000000;font-size:12px;padding:5px;background-color:#CEEBFA;">
												<iframe src="manage/hyqz.jsp" frameborder="0" name="hyqz" style="width:100%;height:100%"></iframe> 
											</div>
										</td>
									</tr>
									<!--群组结束-->
									...
									<tr>
										<td colspan='2' id="rightbottom3" align="center" valign="top"  height='130'>
											<div id="rightbottomdiv" style="width:100%;height:130px;color:#000000;font-size:12px;padding:5px;background-color:#CEEBFA;">									 
												<iframe src="manage/latestSites.jsp" frameborder="0" name="hylatestSites" style="width:100%;height:100%"></iframe> 											 	 
											</div>
										</td>
									</tr>
									<!--商业资讯结束-->
