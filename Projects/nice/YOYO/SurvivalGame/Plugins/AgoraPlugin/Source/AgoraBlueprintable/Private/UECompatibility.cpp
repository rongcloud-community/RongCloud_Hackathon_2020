...
FRtcStats::operator agora::rtc::RtcStats()
{
   ...
   statistics.gatewayRtt = GatewayRtt;
   statistics.memoryAppUsageRatio = MemoryAppUsageRatio;
   statistics.memoryTotalUsageRatio = MemoryTotalUsageRatio;
   statistics.memoryAppUsageInKbytes = MemoryAppUsageInKbytes;
   return statistics;
}
...
agora::rtc::VideoEncoderConfiguration convert( const FVideoEncoderConfiguration& configuration )
{
   ...
   conf.mirrorMode = convert( configuration.MirrorMode );
   return conf;
}
...
agora::rtc::AUDIO_REVERB_PRESET convert( EAUDIO_REVERB_PRESET audioReverbPreset )
{
   switch( audioReverbPreset )
   {
      ...
      case AUDIO_REVERB_FX_KTV: return agora::rtc::AUDIO_REVERB_FX_KTV;
      case AUDIO_REVERB_FX_VOCAL_CONCERT: return agora::rtc::AUDIO_REVERB_FX_VOCAL_CONCERT;
      case AUDIO_REVERB_FX_UNCLE: return agora::rtc::AUDIO_REVERB_FX_UNCLE;
      case AUDIO_REVERB_FX_SISTER: return agora::rtc::AUDIO_REVERB_FX_SISTER;
      case AUDIO_REVERB_FX_STUDIO: return agora::rtc::AUDIO_REVERB_FX_STUDIO;
      case AUDIO_REVERB_FX_POPULAR: return agora::rtc::AUDIO_REVERB_FX_POPULAR;
      case AUDIO_REVERB_FX_RNB: return agora::rtc::AUDIO_REVERB_FX_RNB;
      case AUDIO_REVERB_FX_PHONOGRAPH: return agora::rtc::AUDIO_REVERB_FX_PHONOGRAPH;
      case AUDIO_VIRTUAL_STEREO: return agora::rtc::AUDIO_VIRTUAL_STEREO;
#endif
...
#ifndef TARGET_OS_IPHONE
      case RENDER_MODE_FILL: return agora::rtc::RENDER_MODE_FILL;
#endif
...
#ifndef TARGET_OS_IPHONE
      case VOICE_BEAUTY_VIGOROUS: return agora::rtc::VOICE_BEAUTY_VIGOROUS;
      case VOICE_BEAUTY_DEEP: return agora::rtc::VOICE_BEAUTY_DEEP;
      case VOICE_BEAUTY_MELLOW: return agora::rtc::VOICE_BEAUTY_MELLOW;
      case VOICE_BEAUTY_FALSETTO: return agora::rtc::VOICE_BEAUTY_FALSETTO;
      case VOICE_BEAUTY_FULL: return agora::rtc::VOICE_BEAUTY_FULL;
      case VOICE_BEAUTY_CLEAR: return agora::rtc::VOICE_BEAUTY_CLEAR;
      case VOICE_BEAUTY_RESOUNDING: return agora::rtc::VOICE_BEAUTY_RESOUNDING;
      case VOICE_BEAUTY_RINGING: return agora::rtc::VOICE_BEAUTY_RINGING;
      case VOICE_BEAUTY_SPACIAL: return agora::rtc::VOICE_BEAUTY_SPACIAL;
      case GENERAL_BEAUTY_VOICE_MALE_MAGNETIC: return agora::rtc::GENERAL_BEAUTY_VOICE_MALE_MAGNETIC;
      case GENERAL_BEAUTY_VOICE_FEMALE_FRESH: return agora::rtc::GENERAL_BEAUTY_VOICE_FEMALE_FRESH;
      case GENERAL_BEAUTY_VOICE_FEMALE_VITALITY: return agora::rtc::GENERAL_BEAUTY_VOICE_FEMALE_VITALITY;
#endif
...
#if (defined(__APPLE__) && TARGET_OS_MAC && !TARGET_OS_IPHONE) || defined(_WIN32) || defined(__ANDROID__)
...
agora::rtc::ChannelMediaOptions convert( const FChannelMediaOptions& MediaOptions )
{
   ...
   mediaOptions.autoSubscribeAudio = MediaOptions.AutoSubscribeAudio;
   mediaOptions.autoSubscribeVideo = MediaOptions.AutoSubscribeVideo;
   return mediaOptions;
}

agora::rtc::VideoCanvas convert( const FVideoCanvas& videoCanvas )
{
   agora::rtc::VideoCanvas videoCanv( videoCanvas.View->GetPlainData(),
                                      videoCanvas.RenderMode,
                                      TCHAR_TO_ANSI( *videoCanvas.ChannelId ),
                                      videoCanvas.Uid,
                                      convert( videoCanvas.MirrorMode ) );
   return videoCanv;
}
...
FAudioVolumeInfo convert( const agora::rtc::AudioVolumeInfo& volumeInfo )
{
   ...
   info.ChannelId = ANSI_TO_TCHAR( volumeInfo.channelId );
   return info;
}
...
#ifndef TARGET_OS_IPHONE
   remVideoStats.TotalActiveTime = remoteVideoStats.totalActiveTime;
#endif
...
FRemoteAudioStats convert( const agora::rtc::RemoteAudioStats& remoteAudioStats )
{
   FRemoteAudioStats remAudioStats;
   remAudioStats.AudioLossRate = remoteAudioStats.audioLossRate;
   remAudioStats.FrozenRate = remoteAudioStats.frozenRate;
   remAudioStats.JitterBufferDelay = remoteAudioStats.jitterBufferDelay;
   remAudioStats.NetworkTransportDelay = remoteAudioStats.networkTransportDelay;
   remAudioStats.NumChannels = remoteAudioStats.numChannels;
   remAudioStats.Quality = remoteAudioStats.quality;
   remAudioStats.ReceivedBitrate = remoteAudioStats.receivedBitrate;
   remAudioStats.ReceivedSampleRate = remoteAudioStats.receivedSampleRate;
   remAudioStats.TotalFrozenTime = remoteAudioStats.totalFrozenTime;
   remAudioStats.Uid = remoteAudioStats.uid;
#ifndef TARGET_OS_IPHONE
   remAudioStats.TotalActiveTime = remoteAudioStats.totalActiveTime;
#endif
