...
public:
   ...
   /**@deprecated replaced by @ref UIAgora::OnRemoteVideoStateChangedDelegate "OnRemoteVideoStateChanged" @ref UIAgora::OnFirstRemoteVideoFrameDelegate "OnFirstRemoteVideoFrame" */
   virtual void onFirstRemoteVideoFrame( agora::rtc::uid_t Uid, int Width, int Height, int Elapsed ) override;
   
   /**@deprecated This method is deprecated, use the \ref UIAgora::OnRemoteAudioStateChangedDelegate "OnRemoteAudioStateChanged" callback instead.
   ...
   /** @deprecated This callback is deprecated. Use @ref UIAgora::OnRemoteAudioStateChangedDelegate "OnRemoteAudioStateChanged" instead.
   ...
   /** @deprecated This method is deprecated, use the \ref UIAgora::OnRtmpStreamingStateChangedDelegate "OnRtmpStreamingStateChanged" callback instead.
   ...
   /** @ref UIAgora::OnFacePositionChangedDelegate "OnFacePositionChanged" */
   virtual void onFacePositionChanged( int ImageWidth, int ImageHeight, agora::rtc::Rectangle* VecRectangle, int* VecDistance, int NumFaces );
