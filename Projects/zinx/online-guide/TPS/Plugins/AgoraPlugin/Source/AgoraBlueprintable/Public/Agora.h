...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams( FFacePositionChanged, int, ImageWidth, int, ImageHeight, const TArray<FRectangle>&, VecRectangle, const TArray<int>&, VecDistance, int, NumFaces );
...
public:
   ...
   */
   ...
   /**
   @deprecated replaced by \ref OnRemoteVideoStateChangedDelegate "OnRemoteVideoStateChanged"
   ...
   /**
    @deprecated This method is deprecated, use the \ref OnRemoteAudioStateChangedDelegate "OnRemoteAudioStateChanged" callback instead.
   ...
   /**
    @deprecated This callback is deprecated. Use \ref OnRemoteAudioStateChangedDelegate "OnRemoteAudioStateChanged" instead.
  ...
  */
   ...
   /**
    @deprecated This method is deprecated, use the \ref OnRtmpStreamingStateChangedDelegate "OnRtmpStreamingStateChanged" callback instead.
  ...
  When the network connection is interrupted, this callback indicates whether the interruption is caused by a network type change or poor network conditions.
   ...
   /**
      ...
      Once you enable face detection by calling \ref EnableFaceDetection "EnableFaceDetection(true)", you can get the following information on the local user in real-time:
     ...
     */
   UPROPERTY( BlueprintAssignable, Category = "Agora|Callbacks" )
      FFacePositionChanged OnFacePositionChangedDelegate;
  ...
  */
   ...
   /** @deprecated This method is deprecated, use the \ref SetLocalRenderMode( ERENDER_MODE_TYPE RenderMode, EVIDEO_MIRROR_MODE_TYPE MirrorMode ) "SetLocalRenderMode"2 method instead.
    ...
    */
   UFUNCTION( BlueprintCallable, Category = "Agora" )
      int SetLocalRenderModeEx( ERENDER_MODE_TYPE RenderMode );
   ...
   /** Updates the display mode of the local video view.
    ...
    @param RenderMode The rendering mode of the local video view. See #ERENDER_MODE_TYPE.
    @param MirrorMode
    - The mirror mode of the local video view. See #EVIDEO_MIRROR_MODE_TYPE.
   ...
   /** @deprecated This method is deprecated, use the \ref SetRemoteRenderMode( int64 UserId, ERENDER_MODE_TYPE RenderMode, EVIDEO_MIRROR_MODE_TYPE MirrorMode ) "setRemoteRenderMode"2 method instead.
     ...
     */
   UFUNCTION( BlueprintCallable, Category = "Agora" )
      int SetRemoteRenderModeEx( int64 UserId, ERENDER_MODE_TYPE RenderMode );
   ...
   */
   ...
   /**
     @deprecated This method is deprecated, use the \ref UIAgora::SetupLocalVideo "SetupLocalVideo"
     or \ref UIAgora::SetLocalRenderMode "SetLocalRenderMode" method instead.
   ...
   /** Sets the remote video view.
    ...
    To unbind the remote user from the view, set the View in FVideoCanvas to NULL. Once the remote user leaves the channel, the SDK unbinds the remote user.
   ...
   */
   ...
   /** Retrieves the current call ID.
     ...
     @param [out] CallId Pointer to the current call ID.
   ...
   /** Creates and gets an `AgoraRtcChannel` object.
    ...
    - Do not set it as the empty string "". Otherwise, the SDK returns #agora::rtc::ERR_REFUSED (5).
    ...
    */
   UFUNCTION( BlueprintCallable, meta = ( ExpandEnumAsExecs = result ), Category = "Agora" )
      UAgoraChannel* CreateChannel( EResult& result, const FString& ChannelId );
   ...
   */
   ...
   /** Enables/Disables face detection for the local user. Applies to Android and iOS only.
      ...
      Once face detection is enabled, the SDK triggers the \ref OnFacePositionChangedDelegate "OnFacePositionChanged" callback
   ...
   /** Enables loopback recording.
    ...
    @param DeviceName Pointer to the device name of the sound card. Leave empty to use default sound card.
