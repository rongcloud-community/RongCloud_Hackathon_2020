...
public:
	...
	AAgoraVideoActor * AgoraVideoPtr;
	/** holds cheats menu item */
	TSharedPtr<FShooterMenuItem> CheatsItem;
	TSharedPtr<FShooterMenuItem> AgoraItem;
...
protected:
	...
	/** controller agora video handler */
	void AgoraVideoOptionChanged(TSharedPtr<FShooterMenuItem> MenuItem, int32 MultiOptionIndex);
	void AgoraChannelOptionChanged(TSharedPtr<FShooterMenuItem> MenuItem, int32 MultiOptionIndex);
	...
	/** open close Agora video */
	TSharedPtr<FShooterMenuItem> AgoraVideoOption;
