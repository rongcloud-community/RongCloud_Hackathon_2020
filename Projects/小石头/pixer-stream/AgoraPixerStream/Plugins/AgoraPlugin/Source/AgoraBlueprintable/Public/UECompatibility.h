...
public:
   ...
   */
   ...
   /** The video encoding bitrate (Kbps).
     ...
     - #agora::rtc::STANDARD_BITRATE: (Recommended) The standard bitrate.
     ...
     - #agora::rtc::COMPATIBLE_BITRATE: The compatible bitrate: the bitrate stays the same regardless of the profile.

     The Communication profile prioritizes smoothness, while the Live-broadcast profile prioritizes video quality (requiring a higher bitrate). We recommend setting the bitrate mode as #agora::rtc::STANDARD_BITRATE to address this difference.
   ...
   */
   UPROPERTY( VisibleAnywhere, BlueprintReadWrite, Category = "Agora|VideoEncoderConfiguration" )
      TEnumAsByte <EVIDEO_MIRROR_MODE_TYPE> MirrorMode = VIDEO_MIRROR_MODE_AUTO;

   FVideoEncoderConfiguration() {}

   FVideoEncoderConfiguration(
      const FVideoDimensions& d, EFRAME_RATE f,
      int b, EORIENTATION_MODE m, EVIDEO_MIRROR_MODE_TYPE mr )
...
{
   CAPTURER_OUTPUT_PREFERENCE_NONE = 0,
...
enum EAUDIO_REVERB_PRESET
{
   ...
   */
   AUDIO_REVERB_STUDIO = agora::rtc::AUDIO_REVERB_STUDIO,
    ...
    /** 8: The reverberation style typical of a KTV venue (enhanced).
    */
   AUDIO_REVERB_FX_KTV = agora::rtc::AUDIO_REVERB_FX_KTV,
   /** 9: The reverberation style typical of a concert hall (enhanced).
    */
   AUDIO_REVERB_FX_VOCAL_CONCERT = agora::rtc::AUDIO_REVERB_FX_VOCAL_CONCERT,
   /** 10: The reverberation style typical of an uncle's voice.
    */
   AUDIO_REVERB_FX_UNCLE = agora::rtc::AUDIO_REVERB_FX_UNCLE,
   /** 11: The reverberation style typical of a little sister's voice.
    */
   AUDIO_REVERB_FX_SISTER = agora::rtc::AUDIO_REVERB_FX_SISTER,
   /** 12: The reverberation style typical of a recording studio (enhanced).
    */
   AUDIO_REVERB_FX_STUDIO = agora::rtc::AUDIO_REVERB_FX_STUDIO,
   /** 13: The reverberation style typical of popular music (enhanced).
    */
   AUDIO_REVERB_FX_POPULAR = agora::rtc::AUDIO_REVERB_FX_POPULAR,
   /** 14: The reverberation style typical of R&B music (enhanced).
    */
   AUDIO_REVERB_FX_RNB = agora::rtc::AUDIO_REVERB_FX_RNB,
   /** 15: The reverberation style typical of the vintage phonograph.
    */
   AUDIO_REVERB_FX_PHONOGRAPH = agora::rtc::AUDIO_REVERB_FX_PHONOGRAPH,
   /** 16: The reverberation of the virtual stereo. The virtual stereo is an effect that renders the monophonic
    ...
    */
   AUDIO_VIRTUAL_STEREO = agora::rtc::AUDIO_VIRTUAL_STEREO
#endif
};
...
enum ERENDER_MODE_TYPE
{
   ...
   */
   RENDER_MODE_FILL = agora::rtc::RENDER_MODE_FILL,
#endif
};
...
/** Use modes of the \ref agora::media::IAudioFrameObserver::onRecordAudioFrame "onRecordAudioFrame" callback. */
UENUM( BlueprintType )
...
#ifndef TARGET_OS_IPHONE
   /** 7: A more vigorous voice.*/
   VOICE_BEAUTY_VIGOROUS = agora::rtc::VOICE_BEAUTY_VIGOROUS,
   /** 8: A deeper voice.*/
   VOICE_BEAUTY_DEEP = agora::rtc::VOICE_BEAUTY_DEEP,
   /** 9: A mellower voice.*/
   VOICE_BEAUTY_MELLOW = agora::rtc::VOICE_BEAUTY_MELLOW,
   /** 10: Falsetto. */
   VOICE_BEAUTY_FALSETTO = agora::rtc::VOICE_BEAUTY_FALSETTO,
   /** 11: A fuller voice.*/
   VOICE_BEAUTY_FULL = agora::rtc::VOICE_BEAUTY_FULL,
   /** 12: A clearer voice.*/
   VOICE_BEAUTY_CLEAR = agora::rtc::VOICE_BEAUTY_CLEAR,
   /** 13: A more resounding voice.*/
   VOICE_BEAUTY_RESOUNDING = agora::rtc::VOICE_BEAUTY_RESOUNDING,
   /** 14: A more ringing voice.*/
   VOICE_BEAUTY_RINGING = agora::rtc::VOICE_BEAUTY_RINGING,
   /** 15: A more spatially resonant voice.*/
   VOICE_BEAUTY_SPACIAL = agora::rtc::VOICE_BEAUTY_SPACIAL,
   /** 16: (For male only) A more magnetic voice. Do not use it when the speaker is a female; otherwise, voice distortion occurs.*/
   GENERAL_BEAUTY_VOICE_MALE_MAGNETIC = agora::rtc::GENERAL_BEAUTY_VOICE_MALE_MAGNETIC,
   /** 17: (For female only) A fresher voice. Do not use it when the speaker is a male; otherwise, voice distortion occurs.*/
   GENERAL_BEAUTY_VOICE_FEMALE_FRESH = agora::rtc::GENERAL_BEAUTY_VOICE_FEMALE_FRESH,
   /** 18: (For female only) A more vital voice. Do not use it when the speaker is a male; otherwise, voice distortion occurs.*/
   GENERAL_BEAUTY_VOICE_FEMALE_VITALITY = agora::rtc::GENERAL_BEAUTY_VOICE_FEMALE_VITALITY
#endif
};
...
public:
   ...
   /** The unique channel name for the AgoraRTC session in the string format. The string length must be less than 64 bytes. Supported character scopes are:
     ...
     @note
     - The default value is the empty string "". Use the default value if the user joins the channel using the \ref UIAgora::JoinChannel "JoinChannel" method in the UIAgora class. The `FVideoCanvas` struct defines the video canvas of the user in the channel.
     - If the user joins the channel using the \ref UAgoraChannel::JoinChannel "JoinChannel" method in the UAgoraChannel class, set this parameter as the `ChannelId` of the `UAgoraChannel` object. The `FVideoCanvas` struct defines the video canvas of the user in the channel with the specified channel ID.
     */
   UPROPERTY( VisibleAnywhere, BlueprintReadWrite, Category = "Agora|VideoCanvas" )
      FString ChannelId;
   /** The mirror mode of the video view. See EVIDEO_MIRROR_MODE_TYPE
    @note
   ...
   */
   UPROPERTY( VisibleAnywhere, BlueprintReadWrite, Category = "Agora|VideoCanvas" )
      TEnumAsByte < EVIDEO_MIRROR_MODE_TYPE > MirrorMode;
   FVideoCanvas()
   ...
   FVideoCanvas( void* v, int m, FString ch, int u )
      : RenderMode( m )
      , Uid( u )
      , ChannelId( ch )
      , MirrorMode( VIDEO_MIRROR_MODE_AUTO )
   ...
   FVideoCanvas( void* v, int rm, int u, EVIDEO_MIRROR_MODE_TYPE mm )
      : RenderMode( rm )
      , Uid( u )
      , ChannelId( TEXT( "" ) )
      , MirrorMode( mm )
   ...
   FVideoCanvas( void* v, int rm, FString ch, int u, EVIDEO_MIRROR_MODE_TYPE mm )
      : RenderMode( rm )
      , Uid( u )
      , ChannelId( ch )
      , MirrorMode( mm )
...
public:
   /** Determines whether to subscribe to audio streams when the user joins the channel:
    ...
    This member serves a similar function to the \ref UAgoraChannel::MuteAllRemoteAudioStreams "MuteAllRemoteAudioStreams" method. After joining the channel,
   ...
   /** Determines whether to subscribe to video streams when the user joins the channel:
    ...
    This member serves a similar function to the \ref UAgoraChannel::MuteAllRemoteVideoStreams "MuteAllRemoteVideoStreams" method. After joining the channel,
...
agora::rtc::VIDEO_MIRROR_MODE_TYPE convert( EVIDEO_MIRROR_MODE_TYPE mirrorMode );
...
agora::rtc::ChannelMediaOptions convert( const FChannelMediaOptions& MediaOptions );
