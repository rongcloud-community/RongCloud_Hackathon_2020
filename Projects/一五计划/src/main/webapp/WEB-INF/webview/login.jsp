...
<div id="content">
    <div class="content_m">
        <form id="dologin" autocomplete="on" action="/member/login" method="post" onsubmit="return checkreg('dologin');">
            ...
            <div class="login_m">
                <div class="l_box">
                    <div class="l_box_l">手机/邮箱</div><div class="l_box_r"><input type="text" id="username" name="username" texttype="text" value="" backText1="请输入注册时的邮箱或手机号码。" regXe="/(^([a-zA-Z0-9._-])+@([a-zA-Z0-9._-])+(.[a-zA-Z]{2,3})$)|(^0?(13[0-9]|15[012356789]|18[01236789]|14[57])[0-9]{8}$)/" backText2="请输入正确的邮箱地址或11位手机号码。"  /></div><div class="clear"></div>
                </div>
                <div class="l_box">
                    <div class="l_box_l">密&nbsp;　　码</div><div class="l_box_r"><input type="password" id="password" name="password" texttype="text" backText1="请输入您的密码。" /></div><div class="clear"></div>
                </div>
            </div>
            <button class="login_btn_n" type="submit">登录</button>
            <p class="b_log">您还没有美西账号？ <a href="reg" type="submit">立即注册</a></p>
...
<!--baidu--->
<img src="http://hm.baidu.com/hm.gif?si=81629f5b6148e89c2389988e3c83b479&amp;et=0&amp;nv=0&amp;st=4&amp;lt=1427551599&amp;su=http%3A%2F%2Fm.meici.com%2Fmember%2Fregister.html&amp;v=wap-0-0.2&amp;rnd=8392919848" width="0" height="0" /></body>
</html>