    ...
    im.connect(user).then(function(user) {
        ...
        chatRoom.join({
            ...
            $(".pages").append('          <div class="chat-notice">\n' +
                ...
                '          </div>')
            $(".pages").append('<div class="chat-sender" style="width: 300px;">\n' +
                '              <div style="margin-left: 2px;margin-top: 8px;"><span class="iconfont iconguanliyuan" style="font-size: 40px;"></span></div>\n' +
                '              <div>房间公告</div>\n' +
                '              <div>\n' +
                '                  <div class="chat-left_triangle"></div>\n' +
                '                  <span> 当前讨论的是:</span>\n' +
                '                  <div style="width: 150px;height: 200px;display: flex;flex-direction: column;justify-content: center;align-items: center;margin: 5px 0 5px 15px">\n' +
                '                      <img src="${ctx}/shangcheng/uploads/detail/1.jpg" style="width:auto;height:70%;">\n' +
                '                      <p>速比坤 AFBE9BSP303NW29美国进口滚筒洗衣机10.5公斤 <span style="font-size: 20px;color: #CE272D"> ￥36999.00 </span>  </p>\n' +
                '                  </div>\n' +
                '                  <span>请文明发言，网络并非法外之地！</span>\n' +
                '              </div>\n' +
                '          </div>')
