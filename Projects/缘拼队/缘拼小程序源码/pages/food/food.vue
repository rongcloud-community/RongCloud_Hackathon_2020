<template>
	<view class="top">
		<view class="imgt">
			<view class="imgTitle">
				<text style="color: #fff;">拼美食</text><image src="../../static/icon/food.png" mode="" style="margin-left: 30upx; width: 70upx; height: 70upx;"></image>
			</view>
		</view>
		<view class="nav">
		...
		<view class="contents">
			...
			<view :class="contentSubStatus?'contents-subChange':'contents-sub'">
				<text>吃什么呢:</text>
				<input type="text" value="" @input="doWhat" @focus="contentSubChange" @blur="contentSubChange" maxlength="20" placeholder="(例:吃火锅/约烧烤/恰食堂)" />
			</view>
		</view>
