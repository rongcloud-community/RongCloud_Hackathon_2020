<template>
	<view class="top">
		<view class="imgt">
			<view class="imgTitle">
				<text style="color: #fff;">拼娱乐</text><image src="../../static/icon/play.png" mode="" style="margin-left: 30upx; width: 70upx; height: 70upx;"></image>
			</view>
		</view>
		<view class="nav">
			<view :class="nameStatus?'nameChange':'name'">
				<text>标题:</text>
				<input type="text" value="" @input="onKeyInput" @focus="changeName" @blur="changeName" maxlength="15" placeholder="(不超过15个字)" placeholder-style="color:#888"/>
			</view>
			<view class="address">
				<text>地址:</text>
				<view @click="goTo">
		...
		<view class="contents">
			...
			<view :class="contentSubStatus?'contents-subChange':'contents-sub'">
				<text>玩什么呢:</text>
				<input type="text" value="" @input="doWhat" @focus="contentSubChange" @blur="contentSubChange" maxlength="20" placeholder="(例:打篮球/玩桌游/约电影)" />
			</view>
		</view>
