                            ...
                            if(list.length>0){
                                for(var i=0;i<list.length;i++){
                                    lis.push('<div class="layui-show-sm-inline-block cardele" style="width: 23%;margin: 0 5px 10px 5px;">\n' +
                                        ...
                                        '                                <span style="color: #3B78DD;font-size: 12px;">进入讨论组</span>\n' +
                            ...
                            $(".img-fram").click(function () {
                                ...
                                $.ajax({
                                    ...
                                    success : function(re) {
                                        ...
                                        if(tokenresult){
                                            location.href="${ctx}/circle/chatRoom?chatId="+classId+"&userId="+tokenresult["userId"]+"&token="+tokenresult["token"];
                                        }else{
                                            alert(re)
                                        }
                                    },
