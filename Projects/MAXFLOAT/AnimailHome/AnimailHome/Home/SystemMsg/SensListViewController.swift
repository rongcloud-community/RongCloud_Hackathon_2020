...
class SensListViewController: BaseViewController ,UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        viewC.linkUrl = dic!["url"] as? String
    ...
    func loadData(){
        ...
        CoreWork.getSensList(page: "1", pagesize: "\(pageSize!)") { [weak self](obj) in
