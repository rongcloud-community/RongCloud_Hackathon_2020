...
#warning 剪裁区域大小
        _cropView = [[CropView alloc] initWithFrame:CGRectMake(self.scrollView.frame.origin.x, self.scrollView.frame.origin.y, self.scrollView.bounds.size.width, self.scrollView.bounds.size.width*_WH)];
...
#warning 还原
        self.cropView.frame = CGRectMake(self.scrollView.frame.origin.x, self.scrollView.frame.origin.y, self.scrollView.bounds.size.width, self.scrollView.bounds.size.width*_WWHH);
