/*
 * user_infor.java 用户个人资料页面
 *
 * Created on 2007年5月23日, 下午7:12
 */
...
public class user_infor
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws
    ...
    try {
      if (null == action || !"infor".equals(action)) { //判断action的值
        ResultSet rs = null;
        ...
        out.println("<html>\r\n");
        out.println("<head>\r\n");
        out.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><style type=\"text/css\">\r\n");
        out.println("<!--\r\n");
        ...
        out.println("<form name=\"form1\" method=\"post\" action=\"user_infor.do?action=infor\" onSubmit=\"return yanzheng();\">\r\n");
        ...
        out.println("  \r\n");
        out.println("    <tr>\r\n");
        out.println("      <td colspan=\"3\"><div align=\"center\">请如实填写,以备公司紧急调用或通知.</div></td>\r\n");
        out.println("    </tr>\r\n");
        out.println("  </table>\r\n");
        ...
        out.println("window.document.location.href=\"user_infor.do\";\r\n");
        out.println("}\r\n");
        out.println("</script>");
