  ...
  public void doGet(HttpServletRequest request,
    ...
    try {
      ...
      if (null == poste || !"xiugai".equals(poste)) {
        ...
        out.println("<form action=\"user_password.do?poste=xiugai\" method=\"post\" name=\"form1\" onSubmit=\"return yanzheng();\">\r\n");
        out.println(
        ...
        if (!oldmima.equals(rs.getString("userpassword"))) { //判断原始密码是否正确
          ...
          out.println(
              "window.document.location.href=\"user_password.do\";\r\n");
          out.println("}\r\n");
          out.println("</script>");
        }
        else {
          ...
          out.println("window.document.location.href=\"user_password.do\";\r\n");
          out.println("}\r\n");
          out.println("</script>");
