...
//                Toast.makeText(this, "再按一次就退出应用", 0).show();
    ...
    public void onClickUser1(View view) {
        Conversation.ConversationType conversationType  = Conversation.ConversationType.PRIVATE;
        String targetId = "2";
        String title = "user1";

        RongIM.getInstance().startConversation(MainMenuActivity.this , conversationType, targetId, title, null);
    }

    public void onClickUser2(View view) {
        Conversation.ConversationType conversationType  = Conversation.ConversationType.PRIVATE;
        String targetId = "3";
        String title = "user2";
    ...
    public void onClickUser3(View view) {
        Conversation.ConversationType conversationType  = Conversation.ConversationType.PRIVATE;
        String targetId = "4";
        String title = "user3";
