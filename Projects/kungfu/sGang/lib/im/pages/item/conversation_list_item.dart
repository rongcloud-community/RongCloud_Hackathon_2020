...
class _ConversationListItemState extends State<ConversationListItem> {
  ...
  void _onTaped() {
    if (this.delegate != null) {
      this.delegate.didTapConversation(this.conversation, this.info);
    } else {
  ...
  Widget _buildTitle() {
    String title = (conversation.conversationType == RCConversationType.Private
            ? "单聊："
            : "群聊：") +
        (this.info == null || this.info.id == null
            ? ""
            : '[${this.info.id}]${this.info.name}');
    String digest = "";
...
abstract class ConversationListItemDelegate {
  ///点击了会话 item
  void didTapConversation(Conversation conversation, [userInfo]);
