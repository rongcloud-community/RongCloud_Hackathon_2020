...
class RCFont {
  ...
  static const double ExtTextFont = 12;
...
class RCLayout {
  ...
  static const double ExtentionLayoutWidth = 220;
  static const double ExtentionLayoutPhraseWidth = 220;
  static const double ExtentionLayoutEmojiWidth = 240;
...
class RCLongPressAction {
  ...
  static const String DeleteConversationValue = "删除聊天";
...
class RCString {
  static const String BottomInputTextHint = "";
  ...
  static const String SelectConTitle = "选择列表";
  ...
  static const String ExtSecretChat = "隐私回复";
  ...
  static const String RCMessageContentBurn = "[隐私回复]";
...
// 第三方icon
class ThirdPartyIcons {
  // 发现
  static const TogetherExchange =
      IconData(0xe65d, fontFamily: 'ThirdPartyIcons');
  static const ReturnToPreviousPage =
      IconData(0xe6c3, fontFamily: 'ThirdPartyIcons');
  static const OnlineStatus = IconData(0xe617, fontFamily: 'ThirdPartyIcons');

  // 信息列表
  static const CreateAChat = IconData(0xe7da, fontFamily: 'ThirdPartyIcons');
  static const OtherAccount = IconData(0xe708, fontFamily: 'ThirdPartyIcons');

  // 对话栏
  static const LongPressVoice = IconData(0xe67d, fontFamily: 'ThirdPartyIcons');
  static const KeyboardInput = IconData(0xe674, fontFamily: 'ThirdPartyIcons');

  // 个人
  static const PersonalProfileEditor =
      IconData(0xe67a, fontFamily: 'ThirdPartyIcons');
  static const PersonalInformationEditor =
      IconData(0xe605, fontFamily: 'ThirdPartyIcons');
  static const NicknameEditor = IconData(0xe623, fontFamily: 'ThirdPartyIcons');
  static const SignatureEditor =
      IconData(0xe646, fontFamily: 'ThirdPartyIcons');
      static const EnterChatConversation =
      IconData(0xe6ff, fontFamily: 'ThirdPartyIcons');
}
