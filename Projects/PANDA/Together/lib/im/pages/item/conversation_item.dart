...
import 'package:rongcloud_im_plugin_project/other/personal_page.dart';
              ...
              child: InkWell(
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          new SettingPage(id: this.user.id, editable: true),
                    ),
                  );
                },
              ),
              ...
              child: InkWell(
                ...
                onTap: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          new SettingPage(id: this.user.id, editable: false),
                    ),
                  );
                },
              ),
